...
Case of 
	: (Count parameters:C259=0)
		...
		If (Application version:C493<"1740")  // 16R5
	...
	Else 
		...
		$options.title:="define callback methods with formulas?"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D feature"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="1960"  // 1660 means 16R6   1601 means 16.1 (do not use !)
